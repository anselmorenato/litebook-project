...
func_list=[u'向上翻行',u'向下翻行',u'向上翻页',u'向下翻页',u'向上翻半页',u'向下翻半页',u'前进10%',u'后退10%',u'前进1%',u'后退1%',u'跳到首页',u'跳到结尾',u'文件列表',u'打开文件',u'另存为',u'关闭',u'上一个文件',u'下一个文件',u'搜索小说网站',u'重新载入插件',u'选项',u'退出',u'拷贝',u'查找',u'查找下一个',u'查找上一个',u'替换',u'纸张显示模式',u'书本显示模式',u'竖排书本显示模式',u'显示工具栏',u'显示目录',u'全屏显示',u'显示文件侧边栏',u'自动翻页',u'智能分段',u'添加到收藏夹',u'整理收藏夹',u'简明帮助',u'版本更新内容',u'检查更新',u'关于',u'过滤HTML标记',u'切换为简体字',u'切换为繁体字',u'显示进度条',u'增大字体',u'减小字体',u'清空缓存',u'最小化',u'生成EPUB文件',u'启用WEB服务器',u'显示章节侧边栏']

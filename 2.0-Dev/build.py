...
data_files=[('UnRAR2', glob.glob('UnRAR2/*.*')),('icon', glob.glob('icon/*.*')),('background', glob.glob('background/*.*')),('plugin', glob.glob('plugin/*.*')),"litebook2.exe.manifest","litebook.ico","unrar.dll","bh.dat","py.dat","defaultconfig.ini"],

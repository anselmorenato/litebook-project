...
#        data.SetColour(GlobalConfig['CurFColor'])
    ...
    def OnSelectBG(self,evt):
        ...
        if defaultpath=='':
            defaultpath=os.path.dirname(AnyToUnicode(sys.argv[0]))+u'\\background'
        ...
        if rpath<>None and rpath<>'':
            if os.path.dirname(AnyToUnicode(rpath))==os.path.dirname(AnyToUnicode(sys.argv[0]))+u'\\background':
            ...
            if dlg.ShowModal() == wx.ID_OK:
                ...
                for img in img_file_list:
                    ...
                    if fpath<>'' and fpath<>None:
                        if img.find('\\')==-1:
                            fpath=os.path.dirname(AnyToUnicode(sys.argv[0]).encode('GBK'))+'\\background\\'+img
                        try:
            ...
            for r in rlist:
                ...
                try:
                    ...
                    if f[9]<>'None' and f[9]<>'':
                        l['backgroundimg']=f[9]
                        if f[9] in fnamelist:
                            shutil.copyfile(os.environ['TMP']+"\\"+f[9],os.path.dirname(AnyToUnicode(sys.argv[0]))+'\\background\\'+f[9])
                        else:

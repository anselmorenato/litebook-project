...
#This is the source file of LiteBook Linux version
...
BookDB=[]
Ticking=True
Version='1.51 GLIBC2.7'
I_Version=1.51 # this is used to check updated version
...
#unicode(filename)+"','"+ftype+"','"+unicode(zfile)+"',"+str(time.time())
    def load_history(self):
        global SqlCur
        SqlCur.execute("select * from book_history")
        for row in SqlCur:
            filename=row[0]
            ftype=row[1]
            zfilename=row[2]

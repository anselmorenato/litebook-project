...
#
#
#This is the source file of LiteBook Windows version 1.31
...
##        if wheel_delta<>0 and event.RightIsDown():
...
##            else:
##                print " i am here"
##                print str(self.last_mouse_event)
##                if event.RightUp:
...
class MyOpenFileDialog(wx.Dialog,wx.lib.mixins.listctrl.ColumnSorterMixin):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.choice_1 = wx.Choice(self, -1, choices=[u"所有支持的文件格式(*.txt,*.htm,*.html,*.zip,*.rar,*.umd,*.jar)", u"文本文件(*.txt,*.htm,*.html)", u"压缩文件(*.rar,*.zip,*.umd,*.jar)", u"所有文件(*.*)"])
        self.button_4 = wx.Button(self, -1, u"添加")
...
class HelpDialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        # end wxGlade
        try:
            f=open(os.path.dirname(sys.argv[0])+u"\\LiteBook_Readme.txt",'r')
            t_buff=f.read()
        except:
